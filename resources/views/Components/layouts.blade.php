        ...
        <nav class="bg-gray-800">
                    ...
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-8 w-8 rounded-full"
                                src="https://media.licdn.com/dms/image/v2/D4D03AQFd9NE0yVsIKQ/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1680957607861?e=1735776000&v=beta&t=SkgMRxMjIwFbnPVEEBzSDLXcbycQSfqkAGSo2RnwEUE"
                                alt="Your Company">
                        </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <a href="#" class="block rounded-md px-3 py-2 text-base font-medium">About</a>
                    <a href="#" class="block rounded-md px-3 py-2 text-base font-medium">Contact</a>
                </div>
